...
export function getDom() {
  return {
    ...
    classPortraitSlotIndividual: document.getElementById("classPortraitSlotIndividual"),
    classPortraitSlotChalice: document.getElementById("classPortraitSlotChalice"),
    chalicePlaceholderSlot: document.getElementById("chalicePlaceholderSlot"),
    chalicePlaceholderImg: document.getElementById("chalicePlaceholderImg"),
    chalicePopover: document.getElementById("chalicePopover"),
    ...
    illegalErrorBadge: document.getElementById("chaliceIllegalErrorBadge"),
    autoSortWarningBadge: document.getElementById("chaliceAutoSortWarningBadge"),
    autoSortToggleButtons: Array.from(document.querySelectorAll("[data-auto-sort-toggle]")),
    autoSortPills: Array.from(document.querySelectorAll("[data-auto-sort-pill]")),
